...
type Query struct {
	...
	// ExternalTables is additionale external tables.
	// If ExternalTables is not empty, it's sent along with this tables.
...
type ExternalTable struct {
	// Name is the external table name.
	Name string

	// Data is the external table data.
	Data proto.Input
}
